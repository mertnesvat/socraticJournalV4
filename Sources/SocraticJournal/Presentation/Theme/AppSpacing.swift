...
public enum AppSpacing {
    ...
    public static let recordButtonSize: CGFloat = 120

    // Editorial spacing
    public static let heroTopPadding: CGFloat = 60
    public static let sectionGap: CGFloat = 40
    public static let cardGap: CGFloat = 16
    public static let gridGutter: CGFloat = 1
    public static let displayBottomMargin: CGFloat = 24
}
#endif
